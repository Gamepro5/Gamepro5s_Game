...
func on_player_shoot(weilder):
	...
	#print(weilder.get_node("Head").translation.y)
	print(Vector3(weilder.translation.y,weilder.translation.y+1.925,weilder.translation.z))
	print(weilder.get_node("Head").global_transform.origin)
	#print( to_global(weilder.get_node("Head").translation))
	print(" ");
	b.translation = to_global(weilder.get_node("Head").translation)#Vector3(weilder.translation.x, weilder.translation.y+1.925, weilder.translation.z) #1.925 is the y value of the head.
